    ...
    (function () {
        ...
        var p = function (t, x, ak, aj) {
            ...
            if (s.length > 1 && g.exec(t)) {
                ...
                var D = aj ? {expr: s.pop(), set: q(aj)} : p.find(s.pop(), s.length === 1 && x.parentNode ? x.parentNode : x, c(x));
        ...
        var m = p.selectors = {order: ["ID", "NAME", "TAG"], match: {ID: /#((?:[\w\u00c0-\uFFFF_-]|\\.)+)/, CLASS: /\.((?:[\w\u00c0-\uFFFF_-]|\\.)+)/, NAME: /\[name=['"]*((?:[\w\u00c0-\uFFFF_-]|\\.)+)['"]*\]/, ATTR: /\[\s*((?:[\w\u00c0-\uFFFF_-]|\\.)+)\s*(?:(\S?=)\s*(['"]*)(.*?)\3|)\s*\]/, TAG: /^((?:[\w\u00c0-\uFFFF\*_-]|\\.)+)/, CHILD: /:(only|nth|last|first)-child(?:\((even|odd|[\dn+-]*)\))?/, POS: /:(nth|eq|gt|lt|first|last|even|odd)(?:\((\d*)\))?(?=[^-]|$)/, PSEUDO: /:((?:[\w\u00c0-\uFFFF_-]|\\.)+)(?:\((['"]*)((?:\([^\)]+\)|[^\2\(\)]*)+)\2\))?/}, attrMap: {"class": "className", "for": "htmlFor"}, attrHandle: {href: function (r) {
            return r.getAttribute("href")
        }}, relative: {"+": function (r, y, s) {
        ...
        }}, preFilter: {CLASS: function (r, t, s, u, w, v) {
            r = " " + r[1].replace(/\\/g, "") + " ";
            if (v) {
                return r
            }
            ...
            return t[3] - 0 == s
        }}, filter: {PSEUDO: function (w, s, r, v) {
...
(function (k) {
    ...
    function b(m, l, q) {
        ...
        k.extend(m[l], {diffxrat: q.width / (m[l].width - q.width), diffyrat: q.height / (m[l].height - q.height), xtravel: p.travel, ytravel: n.travel, xtravelpx: p.travelpx, ytravelpx: n.travelpx, xoffset: p.offset, yoffset: n.offset});
        if (p.travelpx) {
            o.left = p.cssPos
        }
        if (n.travelpx) {
    ...
    k.fn.jparallax = function (n) {
        ...
        var p = {xparallax: o.xparallax, yparallax: o.yparallax, xorigin: o.xorigin, yorigin: o.yorigin, xtravel: o.xtravel, ytravel: o.ytravel};
        ...
        return this.each(function () {
            var t = {x: 0.5, y: 0.5};
            var x = {x: 0.5, y: 0.5};
            var y = {running: false, frame: o.frameDuration, fire: function (z, A) {
                e(w, t, x);
                a(v, x.x, x.y);
            ...
            var w = k.extend({}, {element: r.element}, l, {xinside: false, yinside: false, active: false, ontarget: false});
            var v = [];
...
(function (a) {
    a.fn.kwicks = function (b) {
        ...
        return this.each(function () {
            ...
            if (e.isVertical) {
                container.css({width: k.eq(0).css("width"), height: (h * k.size()) + (e.spacing * (k.size() - 1)) + "px"})
            } else {
                container.css({width: (h * k.size()) + (e.spacing * (k.size() - 1)) + "px", height: k.eq(0).css("height")})
            }
            var g = [];
            for (i = 0; i < k.size(); i++) {
                g[i] = [];
            ...
            k.each(function (l) {
                ...
                m.bind(e.event, function () {
                    ...
                    var q = e.max - p[l];
                    var n = p[l] / q;
                    m.addClass("active").animate(o, {step: function (t) {
                        var s = q != 0 ? t / q - n : 1;
                        k.each(function (u) {
                            if (u != l) {
            ...
            if (!e.sticky) {
                container.bind("mouseleave", function () {
                    ...
                    l[f] = h;
                    var o = h - m[0];
                    k.eq(0).animate(l, {step: function (q) {
                        var p = o != 0 ? (q - m[0]) / o : 1;
                        for (i = 1; i < k.size(); i++) {
...
(function (a) {
    a.fn.kwicks = function (f) {
        ...
        return this.each(function () {
            ...
            if (e.isVertical) {
                container.css({width: n.eq(0).css("width"), height: (h * n.size()) + (e.spacing * (n.size() - 1)) + "px"})
            } else {
                container.css({width: (h * n.size()) + (e.spacing * (n.size() - 1)) + "px", height: n.eq(0).css("height")})
            }
            var g = [];
            for (i = 0; i < n.size(); i++) {
                g[i] = [];
            ...
            n.each(function (k) {
                ...
                l.bind(e.event, function () {
                    ...
                    var o = e.max - r[k];
                    var m = r[k] / o;
                    l.addClass("active").animate(p, {step: function (t) {
                        var s = o != 0 ? t / o - m : 1;
                        n.each(function (u) {
                            if (u != k) {
            ...
            if (!e.sticky) {
                container.bind("mouseleave", function () {
                    ...
                    l[c] = h;
                    var k = h - o[0];
                    n.eq(0).animate(l, {step: function (q) {
                        var p = k != 0 ? (q - o[0]) / k : 1;
                        for (i = 1; i < n.size(); i++) {
